...
5. Usando el comando `grep`, obtuvimos el resultado siguiente con la información sobre el usuario `emma` . ```bash $ grep emma /etc/passwdemma:x:1000:1000:Emma Smith,42 Douglas St,555.555.5555,:/home/emma:/bin/ksh ```
